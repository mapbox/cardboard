...
module.exports = function(config) {
    ...
    if (!config.features) throw new Error('Features table dyno client must be configured');
    if (!config.search) throw new Error('Search table dyno client must be configured');

    var table = config.features.config.params ?
        config.features.config.params.TableName :
        config.features.config.write.params.TableName;
